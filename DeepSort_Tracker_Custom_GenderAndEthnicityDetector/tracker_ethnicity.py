...
ap.add_argument('-c', '--config', 
                help = 'path to yolo config file', default=r'yolov3_custom_eth.cfg')
ap.add_argument('-w', '--weights', 
                help = 'path to yolo pre-trained weights', default=r'yolov3_custom_eth_last.weights')
ap.add_argument('-cl', '--classes', 
                help = 'path to text file containing class names',default=r'obj_eth.names')
args = ap.parse_args()
...
nv = []                  #final total number of persons viewed the advertisement
count=0
temp=[]
total_p=[]               #final total number of persons passed
...
class VideoTracker(object):
    ...
    # apply  non-maximum suppression algorithm on the bounding boxes
            ...
            for i in indices:
                ...
                w = box[2]
                h = box[3]
                if class_ids[i] == 0 or class_ids[i] == 3 or class_ids[i] == 5 or class_ids[i] == 7:
                    c1 = c1 + 1
                elif class_ids[i] == 1 or class_ids[i] == 2 or class_ids[i] == 4 or class_ids[i] == 6:
                    c2 = c2 + 1
                else:
                    pass
